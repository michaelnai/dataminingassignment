...
headlines = pd.read_csv("https://raw.githubusercontent.com/michaelnai/dataminingassignment/master/milestone6_data/headlines_df_m6.csv",index_col=0)
headlines = headlines.rename({'date':'Date'},axis='columns')
headlines_test = pd.read_csv("https://raw.githubusercontent.com/michaelnai/dataminingassignment/master/milestone6_data/headlines_df_m6_test.csv",index_col=0)
headlines_test = headlines_test.rename({'date':'Date'},axis='columns')

headlines = pd.concat([headlines,headlines_test])

stocks = pd.read_csv("https://raw.githubusercontent.com/michaelnai/dataminingassignment/master/milestone6_data/cleaned_stock_data_m6.csv",index_col=0,dtype={'code':'object'})
stocks_test = pd.read_csv("https://raw.githubusercontent.com/michaelnai/dataminingassignment/master/milestone6_data/cleaned_stock_data_m6_test.csv",index_col=0,dtype={'code':'object'})
